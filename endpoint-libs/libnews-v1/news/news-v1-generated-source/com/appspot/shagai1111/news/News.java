...
package com.appspot.shagai1111.news;
...
public class News extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the news library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "news/v1/";
  ...
  /**
   * Create a request for the method "all".
   *
  ...
  public class All extends NewsRequest<com.appspot.shagai1111.news.model.JsonMap> {

    private static final String REST_PATH = "map_integer_article";
     ...
     */
    protected All() {
      super(News.this, "GET", REST_PATH, null, com.appspot.shagai1111.news.model.JsonMap.class);
    }
   ...
   *
   * @param content the {@link com.appspot.shagai1111.news.model.Article}
   * @return the request
   */
  public Create create(com.appspot.shagai1111.news.model.Article content) throws java.io.IOException {
    Create result = new Create(content);
    initialize(result);
    return result;
  }

  public class Create extends NewsRequest<com.appspot.shagai1111.news.model.Message> {

    private static final String REST_PATH = "createArticle";
     ...
     * @since 1.13
     */
    protected Create(com.appspot.shagai1111.news.model.Article content) {
      super(News.this, "POST", REST_PATH, content, com.appspot.shagai1111.news.model.Message.class);
    }
